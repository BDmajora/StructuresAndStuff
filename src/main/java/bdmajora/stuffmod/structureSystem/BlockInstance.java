...
public class BlockInstance {
	...
	public BlockInstance(@NotNull Block block, @NotNull BlockPosition pos, TileEntity tile) {
		this.block = block;
		this.pos = pos;
		this.tile = tile;
	}

	public BlockInstance(@NotNull Block block, @NotNull BlockPosition pos, int meta, TileEntity tile) {
		this.block = block;
		this.pos = pos;
		this.tile = tile;
		this.meta = meta;
