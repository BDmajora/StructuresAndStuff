...
public class BlockModelRegistrar {
	...
	public static void registerBlockModels() {
		...
		ModelHelper.setBlockModel(StuffBlocks.nether_brick, () -> {
			return (new BlockModelStandard(StuffBlocks.nether_brick)).setAllTextures(0, "stuffmod:block/nether_bricks");
		});
		ModelHelper.setBlockModel(StuffBlocks.nether_brick_slabs, () -> {
			return (new BlockModelSlab(StuffBlocks.nether_brick_slabs)).setAllTextures(0, "stuffmod:block/nether_bricks");
		});
		ModelHelper.setBlockModel(StuffBlocks.nether_brick_stairs, () -> {
			return (new BlockModelStairs(StuffBlocks.nether_brick_stairs)).setAllTextures(0, "stuffmod:block/nether_bricks");
		});
		ModelHelper.setBlockModel(StuffBlocks.nether_brick_fence, () -> {
			return (new BlockModelFence(StuffBlocks.nether_brick_fence)).setAllTextures(0, "stuffmod:block/nether_bricks");
		});
	}
}
